...
rplayer = PhotoImage(file="red.gif")
bplayer = PhotoImage(file="blue.gif")
yplayer = PhotoImage(file="yellow.gif")
gplayer = PhotoImage(file="green.gif")
boar = PhotoImage(file='bod.gif')
...
class YBox:                               #Class of yellow box
    ...
    def __init__(self, num=-1, x=0, y=0, x0=0, y0=0, double=False, ):
        ...
        self.x0 = x0
        self.y0 = y0
        self.rap = Label(image=yplayer, width=20, height=20)        #image of game piece.
...
class GBox:                             #Class of green box
    ...
    def __init__(self, num=-1, x=0, y=0, x0=0, y0=0, double=False, ):
        ...
        self.x0 = x0
        self.y0 = y0
        self.rap = Label(image=gplayer, width=20, height=20)
        self.double = double
...
class BBox:                           #Class of Blue box
    ...
    def __init__(self, num=-1, x=0, y=0, x0=0, y0=0, double=False, ):
        ...
        self.x0 = x0
        self.y0 = y0
        self.rap = Label(image=bplayer, width=20, height=20)
        self.double = double
...
class Box:   # class of red box
    ...
    def __init__(self, num=-1, x=0, y=0, x0=0, y0=0, double=False, ):
        ...
        self.x0 = x0
        self.y0 = y0
        self.rap = Label(image=rplayer, width=20, height=20)
        self.double = double
